...
public class Homeapplincesfullactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeapplincesfullactivity);
        ...
        HashMap<String, String> userDetails = new SessionManagerUser(Homeapplincesfullactivity.this).getUserDetails();
    ...
    private void initializeViews() {
        pname = findViewById(R.id.nameb11);
        cart = findViewById(R.id.shocart);
        price = findViewById(R.id.priceb11);
//        material = findViewById(R.id.materialb1);
        btnincr = findViewById(R.id.btnincb11);
        btndec = findViewById(R.id.btndecb11);
        details = findViewById(R.id.details1);
        displayInteger = findViewById(R.id.valueb11);
        tamount = findViewById(R.id.amountb11);
...
//        packag = findViewById(R.id.packagb1);
        image = findViewById(R.id.image1b11);
        buy = findViewById(R.id.shobuy);
        wishl = findViewById(R.id.showish);
        xs = findViewById(R.id.six);
        s = findViewById(R.id.seven);
        m = findViewById(R.id.eight);
        l = findViewById(R.id.nine);
        xl = findViewById(R.id.ten);
        xxl = findViewById(R.id.eleven);
    }

    private void setupClickListeners() {
        // Set click listeners for size selection
        setupSizeClickListener(xs, "6");
        setupSizeClickListener(s, "7");
        setupSizeClickListener(m, "8");
        setupSizeClickListener(l, "9");
        setupSizeClickListener(xl, "10");
        setupSizeClickListener(xxl, "11");
        ...
        buy.setOnClickListener(v -> {
            if (mininteger == 0) {
                Toast.makeText(Homeapplincesfullactivity.this, "Please Select Quantity", Toast.LENGTH_SHORT).show();
            } else if (TextUtils.isEmpty(selectedSize)) {
                Toast.makeText(Homeapplincesfullactivity.this, "Please Select Size", Toast.LENGTH_SHORT).show();
            } else {
                processPurchase();
            }
        });
    ...
    private void processPurchase() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlBuy, response -> {
            try {
                ...
                if (status.equals("1")) {
                    Toast.makeText(Homeapplincesfullactivity.this, "Buying product", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Homeapplincesfullactivity.this, paymentmethod.class);
                    ...
                    Toast.makeText(Homeapplincesfullactivity.this, message, Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
                Toast.makeText(Homeapplincesfullactivity.this, "Error parsing response", Toast.LENGTH_SHORT).show();
            }
        }, error -> {
            error.printStackTrace();
            Toast.makeText(Homeapplincesfullactivity.this, "Network Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
        }) {
            @Nullable
            @Override
    ...
    private void addToWishlist() {
        StringRequest request = new StringRequest(Request.Method.POST, urlWishlist, response -> {
            try {
                ...
                if (status.equals("1")) {
                    Toast.makeText(Homeapplincesfullactivity.this, "Added to wishlist", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Homeapplincesfullactivity.this, message, Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
    ...
    private void addtocart() {
        StringRequest request = new StringRequest(Request.Method.POST, urlCart, response -> {
            try {
                ...
                if (status.equals("1")) {
                    Toast.makeText(Homeapplincesfullactivity.this, "Product added to cart", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Homeapplincesfullactivity.this, message, Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
                Toast.makeText(Homeapplincesfullactivity.this, "Error adding to cart", Toast.LENGTH_SHORT).show();
            }
        }, error -> {
            Toast.makeText(Homeapplincesfullactivity.this, "Network Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
        }) {
