...
public class Forgotpass2 extends AppCompatActivity {
    ...
    Button confirmpass;
    String password,cpassword,name,status,message,url = config.baseurl+"forgot2.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = intent.getStringExtra("shopphonenumber");
    ...
    private void newPassword() {
        ...
        StringRequest stringRequest =  new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if ("1".equals(status)) {
                    Toast.makeText(Forgotpass2.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Forgotpass2.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Nullable
