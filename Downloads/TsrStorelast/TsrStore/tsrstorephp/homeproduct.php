...
$po=$_POST["category"];
// $st="A";
$stmt = $con->prepare("SELECT id,shopid,shopname,shopnumber,shopcategory,availableproducts,productname,price,package,location,description,image FROM additem where category='$po'");
