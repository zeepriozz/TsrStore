...
<div class="container mt-4">
    ...
    <tbody>
        <?php
        include 'connect.php';
        // SQL query to select id, shopid, shopname, shopnumber, shopecategory, category, availableproducts, productname, price, package, location, discription, image from offer
        $sql = "SELECT id, shopid, shopname, shopnumber, shopecategory, category, availableproducts, productname, price, package, location, discription, image FROM offer";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td style='padding: 10px; border: 1px solid #dee2e6;'>" . $row['shopecategory'] . "</td>";
                ...
                echo "<td style='padding: 10px; border: 1px solid #dee2e6;'>" . $row['discription'] . "</td>";
                echo "<td style='padding: 10px; border: 1px solid #dee2e6;'><img src='uploads/" . $row['image'] . "' width='100' alt='Product Image'></td>";
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='13' style='text-align:center; padding: 10px;'>No offers found</td></tr>";
        }
